...
export default function VacinasPage() {
  ...
  const fetchVacinas = async () => {
    ...
    try {
      ...
      setError(
        'Não foi possível carregar as vacinas. Por favor, tente novamente mais tarde.',
      );
      toast({
        title: 'Erro',
  ...
  if (error) {
    return (
      <div className="container mx-auto py-10">
        ...
        <Button onClick={fetchVacinas} className="mt-4">
          Tentar novamente
        </Button>
      </div>
    );
              ...
              <TableRow>
                ...
                <TableHead>
                  <Input
                    ...
                    onChange={(e) =>
                      handleFilter('periodicidade', e.target.value)
                    }
                  />
                </TableHead>
                <TableHead>
